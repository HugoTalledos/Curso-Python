...
@app.route(r'/' , methods=['GET'])		#se le dice al servidor en que url se ejecuta la funcion 

def contact_book():
	contacts = Contact.query().fetch()
	return render_template('contactbook.html', contacts=contacts)
...
def add_contact():
	...
	if  request.form:
		...
		contact.put() #Añade a base de datos de flask
		flash('Contacto añadido')

	return render_template('add_contact.html')


@app.route(r'/contacts/<uid>', methodo=['GET'])
